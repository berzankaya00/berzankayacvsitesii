<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WEB SİTESİ.aspx.cs" Inherits="WEB_SİTESİİ.WEB_SİTESİ" %>
...
<html lang="en">
  ...
  <head>
    ...
    <title>BERZAN KAYA WEB SİTESİ</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="DOSYALAR/img/bk1.jpg" alt="">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
          ...
          <div class="subheading mb-5">
            ADRES:  <asp:Label ID="Label3" runat="server" Text='<%# Eval("ADRES") %>'></asp:Label> 
              ...
              <p></p>
               ...
               MAIL: <asp:Label ID="Label5" runat="server" TexT='<%# Eval("MAIL") %>' ></asp:Label></a>
          </div>
          <p class="lead mb-5">
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">
                  <asp:Label ID="Label7" runat="server" Text='<%# Eval("BAŞLIK") %>'></asp:Label></h3>
              <div class="subheading mb-3">
                  <asp:Label ID="Label8" runat="server" Text='<%# Eval("ALTBAŞLIK") %>'></asp:Label></div>
              <p>
                  <asp:Label ID="Label9" runat="server" Text='<%# Eval("AÇIKLAMA") %>'></asp:Label> </p>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">
                  <asp:Label ID="Label10" runat="server" Text='<%# Eval("TARİH") %>'></asp:Label></span>
            </div>
          </div>
            </ItemTemplate>
            </asp:Repeater>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="EĞİTİM">
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">
                  <asp:Label ID="Label11" runat="server" Text='<%# Eval("BAŞLIK") %>' ></asp:Label>

              </h3>
              <div class="subheading mb-3"><asp:Label ID="Label12" runat="server" Text='<%# Eval("ALTBAŞLIK") %>' ></asp:Label></div>
              <div><asp:Label ID="Label13" runat="server" Text='<%# Eval("AÇIKLAMA") %>' ></asp:Label></div>
              <p><asp:Label ID="Label14" runat="server" Text='<%# Eval("GNOT") %>' ></asp:Label></p>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary"><asp:Label ID="Label15" runat="server" Text='<%# Eval("TARİH") %>' ></asp:Label></span>
            </div>
          </div>
        </div>
                </ItemTemplate>
        ...
        <div class="my-auto">
          <h2 class="mb-5">HOBİLERİM</h2>
            <asp:Repeater ID="Repeater5" runat="server">
                <ItemTemplate>
          <p>
              <asp:Label ID="Label16" runat="server" Text='<%# Eval("HOBİLERİM") %>'> </asp:Label>
          </p>
        </div>
                </ItemTemplate>
          </asp:Repeater>
